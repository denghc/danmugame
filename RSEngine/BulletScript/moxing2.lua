...
function updateFrame()
	...
	local tmpt = 1
		for i=1, 300 do 
			...
			tmpt = tmpt + 1
			if (i <= 100) then
				vetx[tmpt] = i * 3 * math.sin((i % 20)*0.05 * 2 * 3.1415926)
			elseif(i <= 200) then
				vetx[tmpt] = i *  math.sin((i % 20)*0.05 * 2 * 3.1415926) + 50
			elseif(i <= 300) then
				vetx[tmpt] = i *  math.sin((i % 20)*0.05 * 2 * 3.1415926) - 50
			end			
			tmpt = tmpt + 1
			if (i <= 100) then
				vetx[tmpt] = i * 3 *  math.cos((i % 20)*0.05 * 2 * 3.1415926)
			elseif(i <= 200) then
				vetx[tmpt] = i *  math.cos((i % 20)*0.05 * 2 * 3.1415926) + 50
			elseif(i <= 300) then
				vetx[tmpt] = i *  math.cos((i % 20)*0.05 * 2 * 3.1415926) - 50
			end	
