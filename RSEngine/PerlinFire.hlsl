...
float4 PerlinFire4DPS(VolumeVertex In) : SV_Target
{
    ...
    float3 resultColor = 0;
    float SceneZ = 1.0f;//ScreenDepth.Load( int3( In.ClipPos.xy, 0 ) );
...
technique10 PerlinFire3D
{
    pass P0
    {
        ...
        SetVertexShader( CompileShader( vs_4_0, PerlinFireVS() ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PerlinFire3DPS() ) );
    }
}

// Technique based on 3D flow noise
technique10 PerlinFire3DFlow
{
    pass P0
    {
        SetDepthStencilState( DisableDepthWrites, 0 );
        ...
        SetVertexShader( CompileShader( vs_4_0, PerlinFireVS() ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PerlinFire3DFlowPS() ) );
    }
}

// Technique based on 4D simplex noise
technique10 PerlinFire4D
{
    pass P0
    {
        SetDepthStencilState( DisableDepthWrites, 0 );
        ...
        SetVertexShader( CompileShader( vs_4_0, PerlinFireVS() ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PerlinFire4DPS() ) );
    }
}
...
technique10 RenderGeometry
{
    pass ZOnly
    {
        SetBlendState( DisableColorWrites, float4(0, 0, 0, 0), 0xffffffff );
