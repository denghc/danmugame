...
bool SpritePS::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* psFilename, CHAR* entryFuncName)
{
	HRESULT result;
...
bool SpritePS::InitializeConstantBuffer(ID3D11Device*)
{
...
void SpritePS::Shutdown()
{
	ShutdownShader();

	return;
}
void SpritePS::ShutdownShader()
{
